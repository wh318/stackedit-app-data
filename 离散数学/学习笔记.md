...
<font color=red size=4> **【定义】** </font>设H~1~，H~2~，…，H~n~ 和 C 是 n+1 个命题公式，若H~1~H~2~…Hn→C,则称C为一组前提H,H2,,Hn的有效
结论或逻辑结论。也称由前提H1,H2,…,Hn推出结论C的推
理是有效的或正确的。
H1H2A.…Hn→C,亦可记为H1H2∧.…Hn上C。


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3NzUxMjc3OCwxNjEzMjg4MTU2LC02Nj
UwMjQwMDBdfQ==
-->