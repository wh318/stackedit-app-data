...
<tr align="center"><td rowspan="8">量词辖域缩小或扩大等价式<br>（设B是不含X自由出现， 查A(x)为有x自由出现的任意公式）</td><td>(∀x)(A(x)∧B)⇔(∀x)A(x)∧B</td></tr>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODY4ODMxMDQsMTk3NjgxOTE4OCwtMT
IyMzE5NTE2MiwtMTc1NjU1NjkxNCwtOTg2NDcxMDk4LC0xOTM2
NzczNjM2LDIwMzg2NTg4NjksMjA1MDM1NDc1Myw2MjM5NjM2Mz
csMTYxMzI4ODE1NiwtNjY1MDI0MDAwXX0=
-->