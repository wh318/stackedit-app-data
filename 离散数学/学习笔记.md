...
- 量词辖域缩小或扩大等价式（设B是不含X自由出现， 查A(x)为有x自由出现的任意公式）：
	...
	5.  ($\forall$x)(A(x)$\land$B)$\Leftrightarrow$($\forall$x)A(x)$\land$B
	6. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzAyMDUwODcsLTE5MzY3NzM2MzYsMj
AzODY1ODg2OSwyMDUwMzU0NzUzLDYyMzk2MzYzNywxNjEzMjg4
MTU2LC02NjUwMjQwMDBdfQ==
-->