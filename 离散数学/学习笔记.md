...
<tr align="center"><td rowspan="2">量词否定等价式</td><td>¬∀xQ(x)⇔∃x ¬Q(x)</td></tr>
<tr align="center"><td>¬∃xQ(x)⇔∀x ¬Q(x)</td></tr>
<tr align="center"><td rowspan="8">量词辖域缩小或扩大等价式</td><td>（设B是不含X自由出现， 查A(x)为有x自由出现的任意公式）</td><td>(∀x)(A(x)∧B)⇔(∀x)A(x)∧B</td></tr>
<tr align="center"><td>(∀x)(A(x)∨B)⇔(∀x)A(x)∨B</td></tr>
<tr align="center"><td>(∀x)(A(x)→B)⇔(∃x)A(x)→B</td></tr>
<tr align="center"><td>(∀x)(B→A(x))⇔B→(∀x)A(x)</td></tr>
<tr align="center"><td>(∃x)(A(x)∧B)⇔(∃x)A(x)∧B</td></tr>
<tr align="center"><td>(∃x)(A(x)∨B)⇔(∃x)A(x)∨B</td></tr>
<tr align="center"><td>(∃x)(A(x)→B)⇔(∀x)A(x)→B</td></tr>
<tr align="center"><td>(∃x)(B→A(x))⇔B→(∃x)A(x)</td></tr>
<tr align="center"><td rowspan="2">量词分配律等价式</td><td>(∀x)(A(x)∧B(x))⇔(∀x)A(x)∧(∀x)B(x)</td></tr>
<tr align="center"><td>(∃x)(A(x)∨B(x))⇔(∃x)A(x)∨(∃x)B(x)</td></tr>
</table>
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0OTM2MDgwNywxOTc2ODE5MTg4LC0xMj
