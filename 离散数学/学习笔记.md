...
设A、B为任意两个公式，E是它们的公有个体域
若：
(1)对于公式A和B中的谓词变元，指派以任一在E上有定义
为确定的谓词：
(2)对于谓词公式中的个体变元，指派以E中任一确定的个体
所得的命题具有同样的真值，则称A与B在E上是等价的，记为
A一B,称A一B为等价式
命题逻辑中的基本定律（基本等价式）都是谓词演算的等价
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1MTIwODA5NywyMDUwMzU0NzUzLDYyMz
k2MzYzNywxNjEzMjg4MTU2LC02NjUwMjQwMDBdfQ==
-->